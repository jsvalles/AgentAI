...
function generateMermaidImageHtml(diagramCode) {
  ...
  if(validationError) {
    ...
    return `<div style="background:#ffe0e0;border:2px solid #cc0000;border-radius:8px;padding:12px;margin:12px 0;font-family:monospace;font-size:12px;color:#660000;">
...
function normalizeMermaidCode(rawCode) {
  ...
  // Simplemente asegurar que haya saltos de línea básicos
  // No filtrar agresivamente - confiar en que Claude generó código válido
  
  console.log('📊 Código Mermaid normalizado:', code);
  return code;
}
